...
c.styleSheet?c.styleSheet.cssText=b:c.appendChild(window.document.createTextNode(String(b)));$.We($.Be(window.document,"head",void 0,void 0)[0],c,0);ZD=!0}this.Hd||(this.Hd=$.Ne("DIV","anychart-credits"));this.g||(this.g=$.Ne("A"),this.D=$.Ne("SPAN","anychart-credits-text"),this.b=$.Ne("IMG","anychart-credits"),Ue(this.g,this.D),this.Hd.appendChild(this.g));b=this.f.Al();this.J(fl)&&(b&&b.appendChild(this.Hd),this.I(fl));this.J(gl)&&(b=$.hc.apply(null,[", v%s.%s.%s.%s"].concat(["8","8","0","1931"])),
c=a?this.gJ():"AnyChart - JavaScript Charts designed to be embedded and integrated{{anychart-version}}",$.De(this.b,{alt:a?this.hJ():"AnyChart - JavaScript Charts"}),this.I(gl));this.J(hl)&&(a=a?this.text():"",$.ef(this.D,a),this.I(hl));if(this.J(il)){if(a=nl(this)?this.HE():kl()){if(this.O=a,b=rh($.kg()))$.Id(b,"complete",this.w2,!1,this),$.Id(b,
