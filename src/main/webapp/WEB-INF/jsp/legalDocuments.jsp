	...
	<div class="col-md-12">
		<div class="card shadow">
			...
			<div class="card-header">
				<strong class="card-title">CREATE DOCUMENTS</strong>
			</div>
			<div class="card-body">
				<c:url var="loadDocuments" value="/loadDocuments" />
						<mvc:form method="POST" action="${loadDocuments}"
							...
							<div class="row">
								...
								<div class="col-md-6">
									<label class="bmd-label-floating">Document Title*</label> <input
							...
							<div class="row">
								...
								<div class="col-md-6">
									<label class="bmd-label-floating">About Document*</label> <textarea
								...
								<div class="col-md-6">
									<label class="bmd-label-floating">Attach Document*</label> <input
										class="form-control" type="file" name="gallerys" id="gallerys"
										value="${request.gallerys}" path="gallerys" accept="application/*"
										autocomplete="off">
								</div>
