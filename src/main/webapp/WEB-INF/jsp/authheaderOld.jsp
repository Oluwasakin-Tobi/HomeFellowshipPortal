				...
				<ul class="nav navbar-nav">
					...
					<li class="menu-item-has-children dropdown"><a href="#"
						...
						<ul class="sub-menu children dropdown-menu">
							...
							<li><i class="fa fa-book"></i><a
									href="<c:url value="/message" />">Send Message</a></li>
						...
						<ul class="sub-menu children dropdown-menu">
							...
							<li><i class="fa fa-book"></i><a
									href="<c:url value="/getCentreReport" />">View Centre Report</a></li>
									
							<li><i class="fa fa-book"></i><a
									href="<c:url value="/getAreaReport" />">View Area Report</a></li>
									
							<li><i class="fa fa-book"></i><a
									href="<c:url value="/getZoneReport" />">View Zonal Report</a></li>
									
							<li><i class="fa fa-book"></i><a
									href="<c:url value="/getDistrictReport" />">View District Report</a></li>
							...
							<li><i class="fa fa-book"></i><a
									href="<c:url value="/getVisitorReport" />">View Visitors</a></li>
						</ul></li>
						...
						<ul class="sub-menu children dropdown-menu">
							...
							<li><i class="fa fa-book"></i><a
									href="<c:url value="/training" />">Create Training</a></li>
									
							<li><i class="fa fa-book"></i><a
									href="<c:url value="/centre" />">Create Centre</a></li>
									
									<li><i class="fa fa-book"></i><a
									href="<c:url value="/viewCentre" />">Create Centre</a></li>
						</ul></li>
