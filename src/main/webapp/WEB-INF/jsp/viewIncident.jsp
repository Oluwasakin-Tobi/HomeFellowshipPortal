...
<div class="container-fluid">
	<h1 class="mt-4">View Incident Request</h1>
	<ol class="breadcrumb mb-4">
		<li class="breadcrumb-item"><a
			href="<c:url value='/dashboard' />">Dashboard</a></li>
		<li class="breadcrumb-item active">View Incident Request</li>
	</ol>
	<div class="col-md-12">
		<div class="card shadow">
			<div class="card-header">
				<strong class="card-title">View Incident Request</strong>
			</div>
			<div class="card-body">
				<table id="bootstrap-data-table-export"
					...
					<tbody>
						<c:forEach items="${incident}" varStatus="current" var="response">
							<tr>
								<td>${response.name}</td>
								<td>${response.incident}</td>
								<td><button class="btn btn-danger" type="button"
										data-toggle="modal" data-target="#reject${current.count-1}">Reject</button></td>
							...
							<div class="modal fade" id="reject${current.count-1}"
								...
								<div class="modal-dialog modal-dialog-centered modal-lg"
									...
									<div class="modal-content">
										...
										<c:url var="updateIncident" value="/updateIncident" />
										<mvc:form method="POST" action="${updateIncident}"
											...
											<div class="modal-body">
												...
												<input type="hidden" name="incidentId"
													value="${response.incidentId}" path="incidentId"> <input
