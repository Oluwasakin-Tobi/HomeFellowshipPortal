			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<strong class="card-title">SEND MAIL</strong>
					</div>
					<div class="card-body">
						<c:url var="sendMail" value="/sendMail" />
						<mvc:form method="POST" action="${sendMail}"
							...
							<div class="row">
								...
								<div class="col-md-6">
									<label class="bmd-label-floating">E-mail Address*</label> <textarea
