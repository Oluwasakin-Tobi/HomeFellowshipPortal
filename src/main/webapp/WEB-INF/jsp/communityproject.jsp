...
<div class="container-fluid">
	<h1 class="mt-4">Community Project</h1>
	<ol class="breadcrumb mb-4">
		<li class="breadcrumb-item"><a
			href="<c:url value = '/dashboard'/>">Dashboard</a></li>
		<li class="breadcrumb-item active">Community Project</li>
	</ol>
	<div class="col-md-12">
		<div class="card shadow">
			...
			<div class="card-header">
				<strong class="card-title">COMMUNITY PROJECT</strong>
			</div>
			<div class="card-body">
				<c:url var="communityProject" value="/communityProject" />
						<mvc:form method="POST" action="${communityProject}"
							...
							<div class="row">
								...
								<div class="col-md-6">
									<label class="bmd-label-floating">Community*</label> <input
										...
										value="${request.category}" path="category" required
										autocomplete="off">
								</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<label class="bmd-label-floating">Impact Project*</label> <textarea
